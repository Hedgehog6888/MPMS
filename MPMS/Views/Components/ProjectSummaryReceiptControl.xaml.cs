...
public partial class ProjectSummaryReceiptControl
{
    public ProjectSummaryReceiptControl()
    {
        InitializeComponent();
    }
    ...
    private void ReceiptRow_Click(object sender, MouseButtonEventArgs e)
    {
        ...
        if (!vm.CanEditProjectSummaryReceiptRow(row)) return;
        vm.OpenProjectSummaryReceiptLinePricing(row);
    }
