...

{
    ...
    public List<LocalFile> DisplayedFiles { get; internal set; } = new();
...

    {
        ...
        if (_projectId == projectId && _taskId == taskId && _stageId == stageId && (_cachedImagesFiles.Count > 0 || _cachedDocumentsFiles.Count > 0))
...

    {
        ...
        DisplayedFiles = filtered.ToList();
