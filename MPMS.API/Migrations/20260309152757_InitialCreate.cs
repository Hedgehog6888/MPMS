    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("10000000-0000-0000-0000-000000000001"), "Full system access", "Administrator" },
                    { new Guid("10000000-0000-0000-0000-000000000002"), "Manage projects and tasks", "Project Manager" },
                    { new Guid("10000000-0000-0000-0000-000000000003"), "View and update assigned tasks", "Worker" },
                    { new Guid("10000000-0000-0000-0000-000000000004"), "Read-only access", "Viewer" }
                });
